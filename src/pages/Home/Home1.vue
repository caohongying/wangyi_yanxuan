          ...
          <a>
            <div class="limitTime-warp">
              <div class="left-item">
                ...
                <div class="countdown">
                  <span class="hours time" >{{countdownTime|format-date('HH')}}</span>
                  <span class="colon" >:</span>
                  <span class="mins time" >{{countdownTime|format-date('mm')}}</span>
                  <span class="colon" >:</span>
                  <span class="secs time" >{{countdownTime|format-date('ss')}}</span>
                </div>
